...
| mysql-innodb-cluster | [Repo](https://github.com/openstack-charmers/charm-interface-mysql-innodb-cluster.git) | [Docs](https://github.com/openstack-charmers/charm-interface-mysql-innodb-cluster/blob/master/README.md) | mysql-innodb-cluster | MySQL InnoDB Cluster peer interface |
...
| mysql-router | [Repo](https://github.com/openstack-charmers/charm-interface-mysql-router.git) | [Docs](https://github.com/openstack-charmers/charm-interface-mysql-router/blob/master/README.md) | mysql-router | MySQL Router provides and requiers interfaces |
