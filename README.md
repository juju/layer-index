...
| kubernetes-master-worker-base | [Repo](https://github.com/charmed-kubernetes/layer-kubernetes-master-worker-base) | [Docs](https://github.com/charmed-kubernetes/layer-kubernetes-master-worker-base/blob/master/README.md) | kubernetes-master-worker-base | Base layer for kubernetes-master and kubernetes-worker. |
...
| keystone-fid-service-provider | [Repo](https://github.com/openstack-charmers/charm-interface-keystone-fid-service-provider) | [Docs](https://github.com/openstack-charmers/charm-interface-keystone-fid-service-provider#readme) | keystone-fid-service-provider | An interface to connect a federated identity provider to the Keystone charm |
...
| websso-fid-service-provider | [Repo](https://github.com/openstack-charmers/charm-interface-websso-fid-service-provider) | [Docs](https://github.com/openstack-charmers/charm-interface-websso-fid-service-provider#readme) | websso-fid-service-provider | An interface to connect a federated identity provider to OpenStack dashboard charm |
