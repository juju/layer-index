...
| beats-base | [Repo](https://github.com/canonical/layer-beats-base) | [Docs](https://github.com/canonical/layer-beats-base#readme) | Beats Base | Base layer for Elastic Beats |
...
| cos-agent | [Repo](https://github.com/canonical/charm-interface-cos-agent.git) | [Docs](https://github.com/canonical/charm-interface-cos-agent/blob/main/README.md) | cos-agent | COS Agent 'provider' interface for integration with grafana-agent charm. |
...
| memcache | [Repo](https://github.com/canonical/interface-memcache.git) | [Docs](https://github.com/canonical/interface-memcache.git#readme) | Memcache | Interface for relating memcache. |
...
| prometheus-scrape | [Repo](https://github.com/openstack-charmers/charm-interface-prometheus-scrape) | [Docs](https://github.com/openstack-charmers/charm-interface-prometheus-scrape#readme) | prometheus-scrape | Prometheus Scrape interface |
...
| vault-ha | [Repo](https://github.com/rodrigogansobarbieri/charm-interface-vault-peer) | [Docs](https://github.com/rodrigogansobarbieri/charm-interface-vault-peer#readme) | vault-ha | Interface for managing information with peers in the same Vault service |
